...
const SUBJECT_INFO: Record<string, SubjectInfo> = {
  ...
  fields: {
    title: 'Fields & Galois',
    desc: '把數系擴大到剛好裝下一個方程的根，這個擴張自帶的對稱，決定了方程能不能被開方解出',
    chapters: [
      {
        id: 'ch1',
        label: '第一章',
        title: 'Field 是「除法也安全」的世界',
        desc: 'field 不是「數很多」，而是每個非零元都能被除回去；無解代表世界對某方程封閉不了。從 unit、ideal、char 與 F_p 建立判準。',
        meta: '4 個小節 · 約 30 分鐘',
      },
      {
        id: 'ch2',
        label: '第二章',
        title: '擴張是一個 vector space，維度就是它的大小',
        desc: '造出裝下 √2 的最小世界 ℚ(√2)，把擴張看成 base field 上的向量空間；維度 [L:K] 就是需要幾個獨立方向，並分出有限與無限維。',
        meta: '4 個小節 · 約 35 分鐘',
      },
      {
        id: 'ch3',
        label: '第三章',
        title: '加一個根 = 拿 minimal polynomial 當時鐘',
        desc: '摺回高次冪＝mod 一條方程做 reduction；那條方程是 minimal polynomial，K(α) ≅ K[x]/(m)。m irreducible 時就是 field——多項式版的「質數」。',
        meta: '5 個小節 · 約 45 分鐘',
      },
      {
        id: 'ch4',
        label: '第四章',
        title: '塔的維度會相乘',
        desc: '把擴張疊成塔，總維度相乘 [L:F]=[L:K][K:F]；大 basis 是兩層乘積 grid。每層乘相對次數，且子擴張次數必整除塔高——∛2 進不了 2 的冪世界。',
        meta: '3 個小節 · 約 30 分鐘',
      },
      {
        id: 'ch5',
        label: '第五章',
        title: '尺規作圖 = 二次擴張的塔',
        desc: '每步尺規只解到二次，串成二次塔 → 作圖數維度必是 2 的冪。倍立方、三等分角（次數 3）、化圓為方（π 超越）都不可能；並釐清「2 的冪」是必要非充分。',
        meta: '4 個小節 · 約 40 分鐘',
      },
      {
        id: 'ch6',
        label: '第六章',
        title: '進來一個根，全家都得進來',
        desc: '加一根未必帶全家（ℚ(∛2) 缺兩複根）。splitting field 把全部根裝進最小世界；normal＝沒有半個家族；char 0/finite 下 separable 免費——湊齊談對稱的舞台。',
        meta: '4 個小節 · 約 35 分鐘',
      },
    ],
  },
