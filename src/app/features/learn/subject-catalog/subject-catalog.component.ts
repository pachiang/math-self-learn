        ...
        chapters: [
          {
            id: 'ch28',
            label: '第二十八章',
            title: '把獨立 actions 接成座標',
            desc: '用 direct product 表達互不干擾的 action modules。',
            meta: '4 個小節 · 約 35 分鐘',
          },
          {
            id: 'ch29',
            label: '第二十九章',
            title: 'Prime divisor 逼出真實 cycle',
            desc: '從 Cauchy theorem 到 p-group 的 nontrivial center。',
            meta: '4 個小節 · 約 40 分鐘',
          },
          {
            id: 'ch30',
            label: '第三十章',
            title: '最大 p-power 結構一定存在',
            desc: '把 Cauchy seed 逐層擴張成 Sylow p-subgroup。',
            meta: '3 個小節 · 約 35 分鐘',
          },
          {
            id: 'ch31',
          ...
          },
          {
            ...
            label: '第三十二章',
            title: '面對陌生群要看哪裡',
            desc: '依問題選 representation、map、quotient、action 或 Sylow route。',
            meta: '4 個小節 · 約 40 分鐘',
          },
        ],
      },
