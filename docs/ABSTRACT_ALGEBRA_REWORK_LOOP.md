...
| Ch28 Direct product：兩個獨立座標組成一個群 | planned | direct product 是獨立座標網格；每軸各自更新，整體週期由兩軸同步決定 | Ch27／Ch29 boundary review passed；4 幕 storyboard locked，尚未實作 |
| Ch29–Ch32         | pending | 嚴格逐章處理                                             | —                                                                                                                                                                  |
